                    ...
                    <ul class="navbar-nav navbar-nav-scroll mx-auto">
                        ...
                        <li class="nav-item dropdown dropdown-fullwidth">
                            <a class="nav-link dropdown-toggle" href="#" id="megaMenu"
                                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> Lifestyle</a>
                                    ...
                                    <div class="row g-4 p-3 flex-fill">
                                        ...
                                        <div class="col-sm-6 col-lg-3">
                                            <div class="card bg-transparent">
                                                ...
                                                <img class="card-img rounded"
                                                    src="{{ asset('frontend') }}/assets/images/blog/16by9/small/01.jpg"
                                                    alt="Card image">
                                                <div class="card-body px-0 pt-3">
                                                    ...
                                                    <ul
                                                        ...
                                                        <li class="nav-item">
                                                            <a href="#" class="text-reset btn-link">Joan
                                                                Wallace</a>
                                                        </li>
                                        ...
                                        <div class="col-sm-6 col-lg-3">
                                            <div class="card bg-transparent">
                                                <!-- Card img -->
                                                <img class="card-img rounded"
                                                    src="{{ asset('frontend') }}/assets/images/blog/16by9/small/02.jpg"
                                                    alt="Card image">
                                                <div class="card-body px-0 pt-3">
                                                    <h6 class="card-title mb-0"><a href="#"
                                                    ...
                                                    <ul
                                                        class="nav nav-divider align-items-center text-uppercase small mt-2">
                                                        <li class="nav-item">
                                                            <a href="#" class="text-reset btn-link">Lori
                                                                Stevens</a>
                                                        </li>
                                        ...
                                        <div class="col-sm-6 col-lg-3">
                                            <div class="card bg-transparent">
                                                <!-- Card img -->
                                                <img class="card-img rounded"
                                                    src="{{ asset('frontend') }}/assets/images/blog/16by9/small/03.jpg"
                                                    alt="Card image">
                                                <div class="card-body px-0 pt-3">
                                                    <h6 class="card-title mb-0"><a href="#"
                                                    ...
                                                    <ul
                                                        class="nav nav-divider align-items-center text-uppercase small mt-2">
                                                        <li class="nav-item">
                                                            <a href="#" class="text-reset btn-link">Judy
                                                                Nguyen</a>
                                                        </li>
                    ...
                    <div class="col-12">
                        <div
                            ...
                            <div class="tiny-slider-inner" data-autoplay="true" data-hoverpause="true"
                                data-gutter="1" data-arrow="true" data-dots="false" data-items="1">
                                <!-- Slide 1 -->
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <div class="tiny-slider arrow-hover arrow-dark arrow-round">
                            <div class="tiny-slider-inner" data-autoplay="false" data-hoverpause="true"
                                data-gutter="24" data-arrow="true" data-dots="false" data-items-xl="5"
                                data-items-lg="4" data-items-md="3" data-items-sm="2" data-items-xs="2">
                                <!-- Category item -->
                                <div>
                                    <div class="card card-overlay-bottom card-img-scale">
                                        <img class="card-img"
                                            src="{{ asset('frontend') }}/assets/images/blog/1by1/thumb/01.jpg"
                                            alt="card image">
        ...
        <div class="container">
            <div class="row pt-5">
                <div class="col-lg-7 mx-auto text-center">
                    <!-- Logo -->
                    <img class="light-mode-item mx-auto" src="{{ asset('frontend') }}/assets/images/logo.svg"
                        alt="logo">
